...
LibDir["SPIRV_Cross_HLSL_Debug"]   	 = "%{LibDir.vulkan_sdk_folder}/spirv-cross-hlsld.lib"
LibDir["SPIRV_Cross_HLSL_Release"]   = "%{LibDir.vulkan_sdk_folder}/spirv-cross-hlsl.lib"
LibDir["SPIRV_Cross_MSL_Debug"]      = "%{LibDir.vulkan_sdk_folder}/spirv-cross-msld.lib"
LibDir["SPIRV_Cross_MSL_Release"]    = "%{LibDir.vulkan_sdk_folder}/spirv-cross-msl.lib"
